...
Settings &mdash; <?php echo e($setting->admin_title); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="admin_title"
                                    class="form-control <?php $__errorArgs = ['admin_title'];
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="admin_footer"
                                    class="form-control <?php $__errorArgs = ['admin_footer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="email_recived"
                                    class="form-control <?php $__errorArgs = ['email_recived'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="City Origin">
...
unset($__errorArgs, $__bag); ?>" placeholder="Keywords">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="4" placeholder="Description"
                                    wire:model="description"><?php echo e($description); ?></textarea>
        ...
        <div class="card border-0 shadow rounded-lg">
            ...
            <div class="card-body">
                ...
                <div class="text-center">
                    <img src="<?php echo e(Storage::url('public/logo/'.$logo)); ?>" alt=""
...
</script><?php /**PATH D:\laravel\sk-store\resources\views/livewire/console/settings/index.blade.php ENDPATH**/ ?>