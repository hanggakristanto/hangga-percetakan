...
Cart &mdash; <?php echo e($setting->site_title); ?>
                                ...
                                <tr style="background: #edf2f7;">
                                    <td class="b-none" width="25%">
                                        <div class="wrapper-image-cart">
                                            <img src="<?php echo e(Storage::url('public/products/'.$product->image)); ?>"
                                                style="width: 100%;border-radius: .5rem">
                                        </div>
                                    </td>
                                    <td class="b-none" width="50%">
                                        <h5><b><?php echo e($product->title); ?></b></h5>
                                        <table class="table-borderless" style="font-size: 14px">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: .20rem">:</td>
                                                <td style="padding: .20rem"><b><?php echo e($product->unit_weight); ?>

                                                        <?php echo e($product->unit); ?></b></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="b-none text-right">
                                        <div class="text-right">
                                            <button wire:click="removeCart(<?php echo e($product->id); ?>)"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-right set-td ">
                                        <p class="m-0" id="subtotal"> <?php echo e(number_format($totalPrice, '0', '', '.')); ?></p>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="set-td text-left border-0">
                                        <p class="m-0">SHIPPING (<strong><?php echo e($weight); ?></strong> gr)</p>
                                    </td>
            ...
            <div class="col-md-6">
                ...
                <div class="card border-0 shadow rounded-md">
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="<?php echo e(route('customer.auth.login')); ?>" class="btn btn-dark btn-block btn-lg shadow"><i
...
<script>
    ...
    $(document).ready(function () {
        ...
        let grandTotal = "<?php echo e($totalPrice); ?>";
    ...
    $(document).ready(function () {
        ...
        $(document).delegate(".ongkos_kirim", "change", function () {
            ...
            //grand total
            let jumlah = "<?php echo e($totalPrice); ?>";
...
</script><?php /**PATH D:\laravel\sk-store\resources\views/livewire/frontend/cart/index.blade.php ENDPATH**/ ?>